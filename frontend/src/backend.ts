...
export class Backend implements backendInterface {
    ...
    async getSession(arg0: string): Promise<ChatSession> {
        if (this.processError) {
            try {
    ...
    async listSessions(): Promise<Array<ChatSession>> {
        if (this.processError) {
            try {
    ...
    async saveMessage(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMessage(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
